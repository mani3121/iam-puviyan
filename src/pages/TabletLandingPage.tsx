...
const TabletLandingPage = () => {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden flex flex-col">
      ...
      <main className="w-full pt-14 md:pt-16 pb-4 md:pb-6 flex-1 flex items-start">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
          <div className="flex flex-col items-center justify-start gap-6 md:gap-8">
            ...
            {/* Image at bottom */}
            <div className="w-full flex justify-center items-center min-h-[320px]">
              <img src={mobileImage} alt="Mobile App Preview" className="max-w-full h-auto max-h-[420px] md:max-h-[500px]" />
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="w-full border-t border-white/10 bg-black/50 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-3 md:py-4 flex flex-col lg:flex-row justify-between items-center gap-4 md:gap-6">
          <div className="flex flex-col lg:flex-row items-center gap-3 md:gap-4 lg:gap-6 text-center lg:text-left">
            <span className="text-sm md:text-sm text-white/60">© 2025 Puviyan Digital Solutions Private Limited. All rights reserved.</span>
