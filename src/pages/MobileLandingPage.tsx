...
import ContactNowMobile from '../components/ContactNowMobile';
        ...
        <ContentWrapper maxWidth="mobile">
          <div className="py-3 flex flex-col items-center gap-2">
            ...
            <div className="flex items-center gap-2 text-[8px] text-white/40">
              ...
              <span>|</span>
              <button onClick={() => setIsContactOpen(true)} className="hover:text-white transition-colors">Contact Now</button>
            </div>

            <div className="flex items-center gap-1 text-[8px] text-white/40">
              <span>All rights reserved</span>
              <span>{CURRENT_YEAR} Puviyan Digital Solutions Private Limited</span>
            </div>
          </div>
        </ContentWrapper>
        <ContactNowMobile
