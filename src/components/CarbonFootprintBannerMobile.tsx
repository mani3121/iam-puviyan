...
const CarbonFootprintBannerMobile: React.FC<CarbonFootprintBannerMobileProps> = ({ co2Estimate: propCo2Estimate }) => {
  ...
  return (
    <div className="fixed bottom-26 left-0 right-0 z-50 pointer-events-none">
      <ContentWrapper maxWidth="mobile">
        <div className="flex justify-end origin-bottom-right scale-[0.85] sm:scale-[0.9] pointer-events-auto">
          <div 
